...
from models import MLP, CNNMnist, CNNFashion_Mnist, CNNCifar, CNNCifar100  # 自定义模型定义
...
if __name__ == '__main__':
    ...
    if args.model == 'cnn':  # 卷积神经网络模型分支
        ...
        if args.dataset == 'mnist':      # MNIST手写数字识别
            ...
            global_model = CNNCifar100(args=args)  # 适用于CIFAR-100的100类分类CNN
    ...
    plt.savefig(f'./save/nn_{args.dataset}_{args.model}_{args.epochs}.png')  # 保存训练曲线图
